    ...
    <body>
        ...
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Monte Carlo</li>
            </ol>
            <br/>
            <form>
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="puntos" placeholder="Escriba el número de puntos" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#calcular').click(function (event) {
                ...
                $.post('IntegracionMonteCarloServlet', {
                    expresion: expresion,
                    inferior: inferior,
                    superior: superior,
                    puntos: puntos
