...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1 class="mt-4 mb-3">Regla falsa
            </h1>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Regla falsa</li>
            </ol>
            <br/>
            <form>
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label for="inferior" class="col-sm-5 col-form-label">Límite inferior</label>
                                            <div class="col-sm-7">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label for="superior" class="col-sm-5 col-form-label">Límite superior</label>
                                            <div class="col-sm-7">
                        ...
                        <table class="table table-striped">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col">Raíz</th>
                                    <th scope="col">Imagen raíz</th>
