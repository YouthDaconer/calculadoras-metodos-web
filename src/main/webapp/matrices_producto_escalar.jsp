    ...
    <body>
        ...
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Producto Escalar</li>
            </ol>
            <br/>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="text" class="col-form-label">Número escalar (para multiplicar)</label>
                                        <input type="text" class="form-control parametros" placeholder="Escriba el número escalar" id="escalar">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
                    ...
                    function Multiplicar() {
                        ...
                        for (x = 0; x < matriz1.length; x++) {
                            for (y = 0; y < matriz1[x].length; y++) {
                                matrizRes[x][y] = escalar * matriz1[x][y];
                            }
                        }
                    }
                    ...
                    function Comprobar() {
                        ...
                        if (isNaN(filaA) || isNaN(colA)) {
                            ...
                            matrizRes = new CreaMatriz(filaA, colA);
                            CrearFormRes(filaA, colA);
                            contador++;
                        }
                    }
