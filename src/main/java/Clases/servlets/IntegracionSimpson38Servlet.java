...
@WebServlet("/IntegracionSimpson38Servlet")
public class IntegracionSimpson38Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (x1 >= x2 || num_particiones <= 0) {// En caso de algun en el intervalo 0 con el error tolerado
                ...
                resultado = "" + integracion.simpson38();//calculamos
                if (resultado.equals("NaN")) {
                    ...
                    json.put("error", String.valueOf(integracion.getError()));
                }
            }
            out.println(json);
